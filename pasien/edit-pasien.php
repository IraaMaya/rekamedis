  ...
  <label class="form-check-label" for="flexRadioDefault2">
    Wanita
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" name="telpon" id="telpon" placeholder="telpon pasien" pattern="[0-9]{8,}" title ="minimal 8 angka" class="form-control" id="tgl_lahir" value="<?= $pasien ['telpon'] ?>" required>
                </div>
                <div class="form-group mb-3">
