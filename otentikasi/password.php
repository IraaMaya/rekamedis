...
?>
    ...
    <form action="../user/proses-user.php" method="post">
        <div class="form-groub mb-3 col-6">
        ...
        <div class="form-groub mb-3 col-6">
            ...
            <input type="password" name="confPass" class="form-control" id="confPass" placeholder="Masukkan kembali password baru" autocomplete="off" required>
        </div>
